    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <div class="mt-5">
                ...
                <p>Add available classrooms to the system</p>
            </div>
            <hr>
        ...
        <div class="container mt-5 mb-5">
            <form action="add-classrooms-process" method="POST" class="row g-3 needs-validation" novalidate>

                <div class="col-md-12">
                    <label for="subjectname" class="form-label">Classroom*</label>
                    <input type="text" name="CN" class="form-control" id="subjectname" required>
                ...
                <div class="col-12 mt-5">
                    <button class="btn btn-success" type="submit" name="addclassroom">Add classroom</button>
                </div>
            </form>
            <hr>
        </div>
        ...
        <div class="container mt-5 mb-5">
            <h1 class="mb-5">View classrooms</h1>
