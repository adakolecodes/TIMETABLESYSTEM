    ...
    <body>
        ...
        <div class="container mt-5">
            <div>
                ...
                <a href="" class="btn btn-dark" onclick="window.print()">Download teacher list as PDF</a>
                <a href="add-teachers" class="btn btn-success">Add Teacher</a>
            </div>
            <div class="mt-5">
        ...
        <div class="container mt-5 mb-5">
            ...
            <table class="table" id=teacherstable>
                ...
                echo "<tr><td>{$row['faculty_number']}</td>
                    ...
                    <td><a href='add-teachers?edit={$row['faculty_number']}' class='btn btn-primary btn-sm'>Edit</a></td>
