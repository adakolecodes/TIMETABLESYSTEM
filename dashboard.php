                ...
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        ...
                        <p class="mbr-text mbr-fonts-style mb-4 display-7">
                            Manage teacher, courses, classrooms, allocations and timetable</p>
                        <div class="mbr-section-btn mt-3"><a class="btn btn-black display-4" href="generate-timetable">Generate Timetable</a></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card col-12 col-md-6 col-lg-3">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        ...
                        <h5 class="card-title mbr-fonts-style display-7"><strong>Teachers</strong></h5>
                        <p class="card-text mbr-fonts-style display-7">
                            View and add list of all teachers taking various.
                        </p>
                        <div class="mbr-section-btn mt-3"><a class="btn btn-black display-4" href="teachers">View</a><a class="btn btn-danger display-4" href="add-teachers">Add</a></div>
                    </div>
                </div>
            </div>
            <div class="card col-12 col-md-6 col-lg-3">
            ...
            <div class="card col-12 col-md-6 col-lg-3">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        ...
                        <h5 class="card-title mbr-fonts-style display-7"><strong>Classrooms</strong></h5>
                        <p class="card-text mbr-fonts-style display-7">
                            View and Add classrooms
                        </p>
                        <div class="mbr-section-btn mt-3"><a class="btn btn-black display-4" href="add-classrooms">Enter</a></div>
                    </div>
                </div>
            </div>
            <div class="card col-12 col-md-6 col-lg-3">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        ...
                        <h5 class="card-title mbr-fonts-style display-7"><strong>Allot Courses</strong></h5>
                        <p class="card-text mbr-fonts-style display-7">
                            Allot courses to teachers
                        </p>
                        <div class="mbr-section-btn mt-3"><a class="btn btn-black display-4" href="allot-courses">Enter</a></div>
                    </div>
                </div>
            </div>
        </div>
