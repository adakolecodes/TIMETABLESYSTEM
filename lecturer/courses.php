    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <div class="mt-5">
                ...
                <p>If your course does not reflect here even after adding it, kindly wait till it has been allocated to you by the administrator</p>
            </div>
            <hr>
        ...
        <div class="container mt-5 mb-5">
            ...
            <table class="table" id=subjectstable>
                ...
                "SELECT * FROM subjects WHERE allotedto = '$facultynum' or allotedto2 = '$facultynum' or allotedto3 = '$facultynum' ");
