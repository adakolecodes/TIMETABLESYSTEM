                ...
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <h4 class="card-title mbr-fonts-style align-center mb-4 display-1">
                            <strong>Student Dashboard</strong></h4>
                        <p class="mbr-text mbr-fonts-style mb-4 display-7">
                            View courses and timetable</p>
                ...
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        ...
                        <p class="card-text mbr-fonts-style display-7">
                            View list of courses offered by 300 and 400 level for first and second semester.
                        </p>
                        <div class="mbr-section-btn mt-3"><a class="btn btn-black display-4" href="courses">View</a></div>
                    </div>
                </div>
            </div>
            <div class="card col-12 col-md-6 col-lg-3">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        ...
                        <p class="card-text mbr-fonts-style display-7">
                            View and print timetable
                        </p>
                        <div class="mbr-section-btn mt-3"><a class="btn btn-black display-4" href="generate-timetable">View</a></div>
                    </div>
                </div>
            </div>
        </div>
